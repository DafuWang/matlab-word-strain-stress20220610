...
for ii=1:size(column_name,2)
    if 64+I1<=90
        ...
        j=floor((64+I1)/90)-1;
        xlswrite(excel_adress_name,{column_name(ii)},sheet_number,strcat(char(65+j),char(64+I1-(j+1)*26),'1'));%横向应变列
        xlswrite(excel_adress_name,column_content{1,ii},sheet_number,strcat(char(65+j),char(64+I1-(j+1)*26),'2'));%极限横向应变
    end
   I1=I1+1;
end