function [II,fig]=figures_plot_alpha_beta(strian,r_stress,x,y,strain_c,alpha,beta,b,R2_beta,R2_alpha,data_legnend,fitting1_legnend,fitting2_legnend,filename,I,i)
II=I;
fig=figure(I);
...
str1='\frac{\sigma_{cf}}{\sigma_c^\prime}=';
str2='\frac{\sigma_{cl}}{\sigma_c^\prime}=';
